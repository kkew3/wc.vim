if exists("load_tex_wcvim")
    finish
endif
let load_tex_wcvim=1

function! CountTexCEWords()
    try
    ...
    let l:ecount = system("detex " . bufname("%") . " \| " . l:stripwchar . " \| "
                \ . "wc -w \| " . "awk '{ print $1 }' \| tr -d '\n'")
    echon "C " . l:ccount . " E " . l:ecount
endfunction

command! -nargs=0 Wc call CountTexCEWords()
